    ...
    def clean(self):
        ...
        if question_type == 'MCQ':
            ...
            # Validate correct_answer for MCQ
               ...
               # raise forms.ValidationError("Correct answer must be one of the options for MCQ questions.")

       # elif question_type == 'CODE':
            # Clear options for CODE type
            #cleaned_data['options'] = []  # No options for CODE questions
